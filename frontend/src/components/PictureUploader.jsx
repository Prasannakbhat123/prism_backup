      ...
      >
        {isLoading ? (
          <div className="text-center">
            <div className="mb-6">
              <div className="w-16 h-16 border-4 border-gray-400 border-t-blue-500 rounded-full animate-spin mx-auto"></div>
            </div>
            <p className="text-gray-300 text-lg font-medium">Processing files...</p>
      ...
      {Object.keys(files).length > 0 && (
        <div className="flex justify-center">
          <button 
            ...
            disabled={isLoading}
            className={`group relative px-8 py-4 bg-gradient-to-r from-gray-700 to-gray-800 text-white rounded-xl transition-all duration-300 font-semibold shadow-lg ${
              isLoading 
